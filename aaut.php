...
$contents=$madmin->myauthor($start,$per_page, $search);
$count = $madmin->a_count($search);
//$count = $Users_Count;
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content">
                 ...
                 <h3 class="box-title">Manage Authors</h3> <form action="vprod.php" method="post"><input type="text" id="usearch" name="usearch" class="form-control" placeholder="Enter Author ID you want to search For">
		...
		<button class="btn-primary btn">Search</button></form>
							   ...
							   <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									<?php
										...
										{
										?>	
									<tr id="pr<?php echo $data['auid']; ?>">
                                    <td><?php echo $data['auid']; ?></td>
                                    <td><?php echo $data['name']; ?></td>
									<td><?php echo $data['email']; ?></td>
								
									<td><?php if ($userlevel == "1009") { 
									echo '<span  class="btn btn-danger btn-xs deo" id="'.$data['auid'].'">Delete</span>'; }
									?>
