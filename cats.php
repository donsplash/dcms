                        ...
                        <div class="col-md-12">
                            <div class="box">
                                ...
                                <div class="box-body">
									      ...
									      <div class="row">
                                <div class="col-lg-6">
								<a href="scats.php" class="btn btn-danger btn-sm"> Add Sort Catergory</a>
                 ...
                 <h3 class="box-title">Manage Category</h3>
                               ...
                               <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                        ...
                                        {
                                        ?>  
                                    <tr id="cont<?php echo $data['ctid']; ?>">
                                    <td><?php echo $data['ctid']; ?></td>
                                    <td><?php echo $data['cat']; ?></td>
                                    
                                                                    
                                    <td><?php if ($userlevel == "1009") { 
                                    echo '<span  class="btn btn-danger btn-xs deo" id="'.$data['ctid'].'">Delete</span>'; }
                                    ?>
                                    </td>
                                    <?php } ?>
                                    </tbody>
