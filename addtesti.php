...
$data = $madmin->addtest($nm, $com, $des, $em, $mes);
if($data){
	header("Location: vtesti.php");
}else{
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <form action="addtesti.php" method="POST">
                                        <div class="form-group">
											...
											<label>Name</label>											
											<input type="text" size="50" maxlength="250"  name="nm" id="nm" placeholder="Full Name " class="form-control">
                                        </div>
                                        <div class="form-group">
                                            
                                            <label>Company</label>                                         
                                            <input type="text" size="50" maxlength="250"  name="com" id="com" placeholder="Comapny" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            
                                            <label>Designation</label>                                         
                        <input type="text" size="50" maxlength="250"  name="des" id="des" placeholder="Designation" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            
                                            <label>Email</label>                                         
                                            <input type="text" size="50" maxlength="250"  name="em" id="em" placeholder="Email " class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>Message</label>
											<textarea name="mes" class="form-control"></textarea><br>
