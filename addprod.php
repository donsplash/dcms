...
$data = $madmin->addprods($nm, $cat, $price, $pic, $decs, $dt, $ty,$pre, $pc, $pic1, $pic2, $pic3);
if($data){
	$cid = $data;
...
<div id="mis" style="display: none; "><img id="mypic" src="" style="width: 150px; height: 150px;" class="mypic" rel="picid">
<img id="mypic1" src="" style="width: 150px; height: 150px;" class="mypic" rel="picid1"><img id="mypic2" src="" style="width: 150px; height: 150px;" class="mypic" rel="picid2"><img id="mypic3" src="" style="width: 150px; height: 150px;" class="mypic" rel="picid3"></div>
<div id="message"> </div>
                                    <form action="addprod.php" method="POST">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="cat" id="cat" class="form-control">
                                                ...
                                                <?php foreach ($dy as  $cat) {
                                                    ?>
                                                    <option value="<?php echo $cat['scat'];  ?>"><?php echo $cat['scat'];  ?></option>
                                                    <?php
                                                    # code...
                                                }     ?>
                                        ...
                                        <div class="form-group">
                                            <label>Preview / Specifications</label>
