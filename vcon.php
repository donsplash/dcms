...
$contents=$madmin->vcon($start,$per_page, $search);
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content">
                 ...
                 <h3 class="box-title">Manage Contents</h3><form action="user.php" method="post"><input type="text" id="usearch" name="usearch" class="form-control" placeholder="Enter Content ID you want to search For">
		  ...
		  <button class="btn-primary btn">Search</button></form>
							   ...
							   <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									<?php
										...
										{
										?>	
									<tr id="cont<?php echo $data['content_id']; ?>"><td><?php echo $data['content_id']; ?></td>
									...
									echo '<span class="label label-primary">Active</span>';
										...
										?></td>
									<td><?php echo '<a href="conedit.php?contid='.$data['content_id'].'" class="btn btn-success btn-xs">Edit</a>';?><?php if ($userlevel == "1009") { 
									echo '<span  class="btn btn-danger btn-xs deo" id="'.$data['content_id'].'" rel="'.$data['pic'].'">Delete</span>'; }
									?>
									</td>
									<?php } ?>
									</tbody>
