...
$data = $madmin->addprod($nm, $cat, $price, $decs, $pic);
if($data){
	$cid = $data;
...
<div id="message"> </div>
                                    <form action="addpron.php" method="POST">
                                        <div class="form-group">
                                            ...
                                            <input type="text" size="50" maxlength="250"  name="price" id="price" placeholder="Price"><br>
											</div>
