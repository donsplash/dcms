...
$data = $madmin->edw($tit, $cont, $id);
if($data){
	$ac = "Update Widget With ID-";
	$ips = preg_replace('#[^0-9.]#', '', getenv('REMOTE_ADDR'));
	$logs = $madmin->logs($postby, $ac, $ips);
header("Location: vwid.php");
}
}
?>
<!DOCTYPE html>
...
$("#mn").val(data);
    ...
    <body class="skin-blue">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
          ...
          <form action="edw.php" method="POST">
                                        <div class="form-group">
											...
											<div class="form-group">
                                            <label>Title</label>
<input type="text" size="50" maxlength="250"  name="title" id="title" placeholder="Widget Title" value="<?php echo $ge['title'];  ?>" class="form-control">
											
											</div>
									
										<div class="form-group">
											<label>Widget Content</label>
											<textarea cols="100" rows="20" id="content" name="content">
                                            <?php echo $ge['content'];  ?>                                 
                                            </textarea><br>
                                        <button type="submit" class="btn btn-primary">EDIT WidGet</button>
										</div>
