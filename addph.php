...
if ($_SERVER['REQUEST_METHOD'] == 'POST' AND isset($_FILES['image'])) {
  ...
  $p = $madmin->addPhoto($tit, $me, $aid, $dt );
	header("location: vphoto.php?aid=".$aid);
	//exit();
    } else {
      $mes = "Unsupported file";
	  header("location: addph.php");
	  exit();
    }
  } else{
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box">
                                ...
                                <h3 class="box-title"> Add photo to Albulm</h3>
                                </div><!-- /.box-header -->
                                <div class="box-body">
                                    
									      <div class="row">
										  <div class="col-lg-6">
                                    <form enctype="multipart/form-data" action="addph.php" method="POST">
