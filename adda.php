...
$data = $madmin->addAuth($nm, $em, $password);
if($data){
	header("Location: aaut.php");
}else{
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <form action="adda.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label>Email</label>                                         
                                            <input type="email" size="50" maxlength="250"  name="em" id="em" placeholder="Email" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            
                                            <label>Password</label>                                         
                                            <input type="text" size="50" maxlength="250"  name="ps" id="ps" placeholder="Password" class="form-control">
                                        </div>
