        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content">
                 ...
                 <h3 class="box-title">Manage Sub Tree Links</h3>
                                </div><!-- /.box-header -->
                                <div class="box-body">
							   ...
							   <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									<?php
										...
										{
										?>	
									<tr id="cont<?php echo $data['sublink_id']; ?>">
									<td><?php echo $data['content_id']; ?></td>
									<td><?php echo $data['link']; ?></td>
									<td><?php	echo $data['link_idkf']; ?></td>
																	
									<td><?php if ($userlevel == "1009") { 
									echo '<span  class="btn btn-danger btn-xs deo" id="'.$data['sublink_id'].'">Delete</span>'; }
									?>
									</td>
									<?php } ?>
									</tbody>
