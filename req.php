...
$Users_Details_Array=$madmin->nReq($usearch,$ssearch,$start,$per_page);
$Users_Count=$madmin->reqc();
$count = $Users_Count;
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content">
                 ...
                 <h3 class="box-title">Manage Requests</h3><form action="user.php" method="post"><input type="text" id="usearch" name="usearch" class="form-control" placeholder="Enter User ID you want to search For">
		  ...
		  <button class="btn-primary btn">Search</button></form>
                                ...
                                <div class="box-body">
                                    <table class="table table-bordered">
										...
										?>
                                        <tr id="users<?php echo $data['reqid']; ?>">
										 <td style="width: 10px">#<?php echo $data['reqid']; ?></td>
                                            <td><a href="#"><?php echo $data['fname'].' '.$data['lname']; ?></a></td>
											<td>
											<?php echo $data['email']; ?>
