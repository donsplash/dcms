...
if($_POST['ids']){
    ...
    $exts = $_POST['exts'];
    $slink = $_POST['slink'];
    $ul= $madmin->ulink($ids, $link, $cid, $slink, $ext, $exts);
    
    if($ul){
        echo '<script>window.location ="vlink.php";</script>';
    }
}
?>
<!DOCTYPE html>
...
<script src="js/jquery.js"></script>
  ...
  <p><button id="addnew" class="btn btn-primary">Add Another Link</button></p>
					...
					<p></p>
                        ...
                        <h3 class="page-header">EDIT Link!</h3>
						<form action="edlink.php" method="POST">
						<div id="form">
                                        <div class="form-group">
                                            <input type="hidden" name="addu" value="addu">
                                            <input type="hidden" name="ids" value="<?php echo $ln['link_id']; ?>">
											<label>Link</label>
											<input type="text" size="50" maxlength="250"  name="link" id="link" placeholder="Link" value="<?php echo $ln['links']; ?>"><br><br>
											<label>Content ID</label>
											<input type="text" size="50" maxlength="250"  name="cid" id="cid" placeholder="Content ID" value="<?php echo $ln['content_id']; ?>"><br><br>
											<label>Alt</label>
											<input type="text" size="50" maxlength="250"  name="alt" id="altt" placeholder="Alt" value="<?php echo $ln['alt']; ?>"><br><br>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="slink" id="slink">
                                               <option value="<?php echo $ln['sublink']; ?>"><?php
                                                    if($ln['sublink'] == 1){
                                                        echo "YES";
                                                }else{
                                                        echo "No";
										...
										<label>External Link ?</label>
                                            <select class="form-control" name="exts" id="exts">
                                               <option value="<?php echo $ln['external']; ?>"><?php
													if($ln['external'] == 1){
														echo "YES";
													}else{
														echo "No";
