        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content">
                 ...
                 <h3 class="box-title">Manage Banks</h3><a href="addbnk.php" class="btn btn-success">Add Bank</a>
                                </div><!-- /.box-header -->
                                <div class="box-body">
							   ...
							   <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									<?php
										...
										{
										?>	
									<tr id="cont<?php echo $data['bid']; ?>">
									<td><?php echo $data['bid']; ?></td>
									<td><?php echo $data['bank']; ?></td>
                                    <td><?php echo $data['name']; ?></td>
									<td><?php echo $data['accn']; ?></td>
																	
									<td><?php if ($userlevel == "1009") { 
									echo '<span  class="btn btn-danger deo" id="'.$data['bid'].'">Delete</span>'; }
									?>
									</td>
									<?php } ?>
									</tbody>
